         ...
         <?php }else{ ?>
          ...
          foreach ($kunjungan as $k): ?>
           <tr>
             ...
             <?php } ?> 
             <?php echo $this->session->userdata('ses_level')=='2' ? '<a onclick="return confirm('.$pesan_hapus.')" class="btn-sm btn-danger" href="'.$base.'beranda/hapus_kunjungan/'.$k->id_kunjungan.'/2/'.$start.'/'.$end.'"><i class="fa fa-trash"></i></a>' : '';?> 
           </td>
         <?php endforeach ?>
       <?php } ?>
