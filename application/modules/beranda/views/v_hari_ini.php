        ...
        <tbody>
          <?php foreach ($kunjungan as $k): ?>
            <tr>
             ...
             <td><?php echo $k->tgl_kunjungan ?></td>
             <td><?php echo $k->jam_masuk ?></td>
             <td><?php echo $k->jam_keluar ?></td>
             <td>
              <a  data-toggle="modal" data-target="#modalkeluar" onclick="edit('<?php echo $k->id_kunjungan ?>')" class="btn-sm btn-primary"><i class="fa fa-eye"></i></a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">ID Kunjungan : <span id="id_kunjungan">ljflsdfhsd</span></h4>
        </div>
        <div class="modal-body">
          <form action="<?php echo site_url('beranda/aksi_keluar') ?>" method="post">
              <div id="non" style="margin-top: 5px;">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nomor Polisi</label>
                  <input class="form-control"  type="text" disabled id="no_pol">

                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Driver</label>
                  <input class="form-control" type="text" disabled id="driver">
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">Tanggal Kunjungan</label>
                  <input class="form-control" type="text" disabled id="tgl">
                </div>
                 <div class="form-group">
                  <label for="exampleInputEmail1">Jam Masuk</label>
                  <input class="form-control" type="text" disabled id="masuk">
                </div>
              </div>
